...
app = FastAPI(
    ...
    description=(
        ...
        "Streaming:\n"
        "- GET /songs/{song_id}/stream is public and supports range requests for efficient "
        "playback."
    ),
    version="2.0.0",
...
# Note: credentials=true requires explicit origins (not '*') in browsers, so we include common
# local dev URLs.
